        ...
        <div class="row">
            <div class="col-sm-6 col-md-4 col-md-offset-4">
                <div class="account-wall">
                    <h1 class="text-center profile-title">Development Team</h1>
                    <br>
                    <form class="form-profile">
                        <label>Project Manager/Programmer</label><h4>Scott Raymond</h4>
                        <br>
                        <label>Programmer</label><h4>Miguel Gaona</h4>
                        <br>
                        <label>Quality Assurance</label><h4>Jorge Coria</h4>
                        <br>
                        <label>Quality Control</label><h4>Sami Ayyoub</h4>
                        <br>
                    </form>
                </div>
            </div>
